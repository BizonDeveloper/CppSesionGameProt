...
void ATPCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		EnhancedInputComponent->BindAction(InteractAction, ETriggerEvent::Completed, this, &ATPCharacter::Interact);
	}
	else
	{
...
void ATPCharacter::Interact()
{
	if (GetLocalRole() == ROLE_AutonomousProxy)	DoInteraction_Server();
}

void ATPCharacter::DoInteraction_Server_Implementation()
{
	if (InteractComponent)InteractComponent->Interact();
}
